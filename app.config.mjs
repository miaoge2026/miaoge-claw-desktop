...
export default {
  // ── 应用身份 ────────────────────────────────────────────────────────────────
  appName:         '喵哥Claw',                    // UI 显示名称
  appId:           'com.miaoge.claw.desktop',         // 反向域名，需全局唯一
  productName:     '喵哥Claw Desktop',                    // 安装包 / Dock 名称
  description:     '喵哥Claw Desktop - OpenClaw GUI for 喵哥',

  // ── Windows 防火墙 ───────────────────────────────────────────────────────────
  firewallRuleName: '喵哥Claw',                   // Windows Defender 规则名称
}
